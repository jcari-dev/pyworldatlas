...
241 primary capitals, 6,265 populated-place records, rich profile fields, five
reviewed UNGEGN local names, and the reviewed land-border graph used by 0.3.1.
Missing values remain missing and are reported rather than synthesized.
