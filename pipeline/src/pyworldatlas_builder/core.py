...
def report(root: Path, normalized: dict[str, object], database: Path) -> None:
    ...
    milestones.extend(
        [
            ...
            {
                "name": "9 — Optional interactive maps",
                "version": "0.9.0",
                "status": "complete",
                "functions": "Optional offline 3D elevation and climate maps, browser display, HTML export, river overlays, and capital markers",
                "tests": "Complete map-pack coverage, record integrity, viewer controls, offline HTML, clean-wheel rendering, documentation, and release gates",
                "dataset": "248 Overview maps / 248 Standard maps from pinned elevation, climate, outline, and river snapshots",
                "docs": "Map-edition guide, installation choices, viewer API, source limits, examples, and release instructions",
                "release": "Published in v0.9.0",
            },
            {
