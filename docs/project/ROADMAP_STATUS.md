...
| 8 — Education and usability | 0.8.0 | planned | City discovery, readable country summaries, coordinate helpers, deterministic learning activities, and API usability polish | Public API, browser runtime, accessibility, examples, typing, and supported-Python release gates | Prefer derived use of the existing reviewed dataset; new fields require separate source and coverage review | Beginner guides, classroom recipes, playground examples, and complete API documentation | — |
| 9 — Stable-API hardening | 0.9.0 | planned | API consistency, performance, typing, packaging, and compatibility polish | Full release-candidate matrix and upgrade-path validation | Reproducibility and coverage hardening without a broad new field family | Stable-API review, migration guidance, and complete reference audit | — |
