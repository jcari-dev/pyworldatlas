...
def status(*, write: bool = True) -> None:
    ...
    if write:
        ...
        rst_lines = [
            ...
            "",
            f"      **{data['library_version']}**",
            "",
            "      library version",
            "",
            "   .. container:: atlas-stat",
            "",
            f"      **{data['dataset_version']}**",
            "",
            "      dataset version",
            "",
            "   .. container:: atlas-stat",
            ...
            "",
            f"      **{coverage['countries']}** profiles · "
            f"**{coverage['local_names']}** local identities · "
            f"**{coverage['english_formal_names']}** English formal names",
            "",
            "   .. container:: atlas-card atlas-card-teal",
            "",
            "      .. rubric:: Places and connections",
            "",
            f"      **{coverage['capitals']}** capitals · "
            f"**{coverage['major_cities']:,}** populated places · "
            f"**{coverage['reviewed_land_borders']}** reviewed land borders",
            "",
            "   .. container:: atlas-card atlas-card-gold",
            "",
            "      .. rubric:: Physical world",
            "",
            f"      **{coverage['physical_profiles']}** physical profiles · "
            f"**{coverage['river_records']}** rivers · "
            f"**{coverage['lake_records']}** lakes · "
            f"**{coverage['koppen_geiger_profiles']}** climate profiles",
            "",
            "Detailed coverage",
            "-----------------",
            "",
            ...
            "   * - Core geography",
            f"     - {coverage['countries']} countries and areas; "
            f"{coverage['capitals']} capitals; {coverage['capital_coordinates']} capital coordinates",
            "   * - Names and profiles",
            f"     - {coverage['local_names']} local identities across "
            f"{coverage['local_name_languages']} languages and "
            f"{coverage['local_name_scripts']} scripts; "
            f"{coverage['population_profiles']} population profiles",
            "   * - Reference facts",
            f"     - {coverage['anthem_titles']} anthem titles; "
            f"{coverage['mottos']} reviewed mottos; "
            f"{coverage['demonyms']} English demonym profiles",
            ...
            f"     - {coverage['coastline_profiles']} coastlines; "
            f"{coverage['elevation_extreme_profiles']} elevation-extreme pairs; "
            f"{coverage['climate_summary_profiles']} climate summaries",
            "",
            "Build identity",
            "--------------",
            "",
